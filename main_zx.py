...
from model_zx import East
from loss import *
# from data_utils import custom_dset, collate_fn
from data_utils_zx import custom_dset, collate_fn
import time
# from tensorboardX import SummaryWriter
# import config as cfg
import config_zx as cfg
from utils.init import *
from utils.util import *
# from utils.save import *
from utils.save_zx import *
from utils.myzip import *
import torch.backends.cudnn as cudnn
# from eval import predict
from eval_zx import predict
...
def get_args():
    ...
    parser.add_argument('--train_img_dir', default='D:\\data_public\\OCR\\ICDAR_2015\\2015ch4_training_images')
    parser.add_argument('--train_gt_dir', default='D:\\data_public\\OCR\ICDAR_2015\\2015ch4_training_localization_transcription_gt')
...
def main(args):
    ...
    trainset = custom_dset(args.train_img_dir, args.train_gt_dir)
    ...
    train_loader = DataLoader(trainset, batch_size=args.batch_size, shuffle=True, collate_fn=collate_fn, num_workers=0)
    print('EAST <==> Prepare <==> Batch_size:{} <==> Begin'.format(args.batch_size))
